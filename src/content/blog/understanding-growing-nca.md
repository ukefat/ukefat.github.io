...
different because the current internal state and state of the cell’s neighbors
...
about their current surroundings. That’s what we are going to do now!
...
filters, so I’m following same thing. Also makes things simpler!*
